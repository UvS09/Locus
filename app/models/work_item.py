...
class WorkItem(Base):
    ...
    level: Mapped[WorkItemLevel] = mapped_column(Enum(WorkItemLevel, name="work_item_level", create_type=False), nullable=False)
    title: Mapped[str] = mapped_column(String(255), nullable=False)
    description: Mapped[str] = mapped_column(Text, default="", nullable=False)
    status: Mapped[WorkItemStatus] = mapped_column(Enum(WorkItemStatus, name="work_item_status", create_type=False), default=WorkItemStatus.PENDING, nullable=False)
    priority: Mapped[TaskPriority] = mapped_column(Enum(TaskPriority, name="work_item_priority", create_type=False), default=TaskPriority.MEDIUM, nullable=False)
